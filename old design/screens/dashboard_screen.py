# =============================================================================
# screens/dashboard_screen.py — NiceGUI Dashboard Screen & App Layout Shell
# =============================================================================
#
# Main Application Shell managing sidebar navigation, top navbar, and screen routing.
# Supports full responsive Light and Dark themes with high-contrast CSS overrides.
#
# =============================================================================
...
from ui_theme import Styles, NAV_ITEMS, STAT_CARDS, QUICK_ACTIONS
...
class MainAppShell:
    ...
    def build_ui(self) -> None:
        ...
        # Head HTML: High-Contrast Theme Overrides & DOM Observer
        ui.add_head_html(
            "<style>\n"
        ...
        with ui.row().classes(Styles.LAYOUT_ROW):
            # ── 1. Collapsible Sidebar (Always dark navy for contrast)
            self._build_sidebar()
