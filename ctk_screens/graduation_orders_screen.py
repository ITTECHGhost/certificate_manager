# =============================================================================
# ctk_screens/graduation_orders_screen.py — Graduation Orders Management Screen (CustomTkinter)
# =============================================================================
...
class GraduationOrderPanel(SidePanel):
    ...
    def _build_fields(self) -> None:
        ...
        self._add_section_label("البيانات الأكاديمية", "Academic Details", row=3, col=3)
